...
<section class="section section-intro context-dark" style="background-color: #de0267!important;">
    ...
    <div class="container">
      ...
      <div class="row row-50 justify-content-center">
        ...
        <div class="col-md col-12 text-center">
          ...
          <h3 class="wow fadeInLeft font-weight-bold" data-wow-delay=".3s">¿Estás iniciando tu propio negocio o necesitas promoción? <span style="color: #de0267!important;"> <br>¿No estás en redes sociales?</span></h3>
      ...
      <div class="row row-50 justify-content-center">
        ...
        <div class="col-xl-6 col-sm-12 col-12 wow fadeInLeft" data-wow-delay=".3s">
            ...
            <div class="pricing-box" style="background-color: #de0267!important;">
